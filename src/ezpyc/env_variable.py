...
def remove_env_variable_value(env_variable_name: str, env_variable_value: str, env_variable_type: EnvVariableType) -> None:
...
def get_env_variable_value(env_variable_name: str, env_var_type: EnvVariableType) -> str:
    try:
        hKey = env_var_type == EnvVariableType.CURRENT_USER and HKEY_CURRENT_USER or HKEY_LOCAL_MACHINE
